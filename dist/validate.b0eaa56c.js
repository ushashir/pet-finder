...
function showAlert(message, className) {
  ...
  div.className = "alert alert-".concat(className); // Add Classes

  div.appendChild(document.createTextNode(message)); // Add Text

  var container = document.querySelector('.container'); // Get Container

  var form = document.querySelector('#pet-form'); // Get Form
...
},{}]},{},["../../../../Users/user/AppData/Roaming/npm/node_modules/parcel-bundler/src/builtins/hmr-runtime.js","js/validate.js"], null)
//# sourceMappingURL=/validate.b0eaa56c.js.map